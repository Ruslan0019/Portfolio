...
function About() {
  return (
    <section className="flex pt-11 justify-center  items-center   pb-11">
      <div className="flex  flex-col   md:flex-row md:w-689px xl:w-720px gap-6 md:gap-5 lg:gap-6 xl:gap-11 ">
        <div>
          <h2 className=" text-text text-center  font-MAZIUS-Italic italic text-[32px] md:text-[32px] xl:text-4xl ">
            about me
          </h2>
        </div>
        <div className="max-w-327px md:max-w-520px lg:max-w-488px xl:max-w-540px ">
          <p className="  md:text-start font-Avenir-Regular text-base xl:text-xl text-text ">
