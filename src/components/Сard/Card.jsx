...
function Card() {
  return (
    <section className="flex pt-6 justify-center  items-center pb-11">
      <div className="flex items-center justify-center drop-shadow-[0_25px_25px_rgb(0,0,0,0.2)]   w-80  md:w-689px  lg:w-960px xl:w-1110px h-60 md:h-292px lg:h-302px xl:h-372px bg-[url('/assets/img/qwerty.png')]   bg-cover bg-center  rounded-3xl  ">
