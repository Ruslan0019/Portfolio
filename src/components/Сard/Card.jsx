      ...
      <div className=" relative  drop-shadow-[0_25px_25px_rgb(0,0,0,0.2)]   w-80  md:w-689px  lg:w-960px xl:w-1110px h-60 md:h-292px lg:h-302px xl:h-372px   rounded-3xl  ">
        <div className="max-w-full flex items-center justify-center absolute inset-0 bg-[#F5F5F0] rounded-3xl  w-80  md:w-689px  lg:w-960px xl:w-1110px h-60 md:h-292px lg:h-302px xl:h-372px ">
          <div className=" w-292px md:w-550px lg:w-804px xl:w-920px ">
            <h2 className=" ml-5 text-darkGray font-MAZIUS-Italic italic text-[28px] md:text-[32px] xl:text-[36px]  ">
              hello!
            </h2>
            <p className="text-darkGray font-Avenir-Regular  ml-5 mt-3  text-base xl:text-xl leading-[130%]">
            ...
            <div className="flex mt-5 md:mt-8 xl:mt-11 justify-between items-center ">
              ...
              <div className="flex flex-col gap-2 md:flex-row   ">
                <button className=" shadow-md shadow-gray-500   text-darkGray pt-2 pb-2 pr-8 pl-8 border-border border-x border-y rounded-3xl  text-xs md:text-sm transform transition-transform duration-300 hover:scale-105 will-change-transform antialiased">
                  VIEV PROJECTS
                </button>
                <button className=" shadow-md shadow-gray-500  bg-[#363636] rounded-3xl pt-2 pb-2 pr-8 pl-8 text-xs md:text-sm transform transition-transform duration-300 hover:scale-105 will-change-transform antialiased">
                  GET IN TOUCH
                </button>
              </div>
            </div>
